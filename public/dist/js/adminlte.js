...
// Function to generate and update the slug
function generateSlug() {
  const titleInput = document.getElementById("slug-source");
  const slugInput = document.getElementById("slug-target");
  ...
  document.getElementById("slug-target-span").textContent = slug;
}

// Add an event listener to the title input field
document.getElementById("slug-source").addEventListener("input", generateSlug);
